...
const RenderCover = props => {
    ...
    const imageStyle = `h-full w-full md:w-full md:h-auto bg-center bg-cover`
    ...
    const titleStyle = `absolute top-[50%] translate-y-[-50%] right-0 left-0 text-white font-bold text-lg z-20
