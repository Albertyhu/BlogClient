...
//This component is used for the Post form where multiple images are uploaded by the user and previewed
//The prop image will come in the following format:
/*
 * image = {
 *      base64: base64 data,
 *      file: file info,
...
const RenderPreview= props => {
    ...
    try {
        return (
            ...
            >
                <img
                    src={isBase64Image(image.base64) ? image.base64 : dataURL}
                    alt={altText}
